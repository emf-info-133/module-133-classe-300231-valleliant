...
public class MatchDTO {
    ...
    private String date; // Format ISO, par ex. "2025-04-08"

    public MatchDTO() { }

    public MatchDTO(Integer id, Integer tournamentId, Integer team1Id, Integer team2Id, String score1, String score2, String date) {
        this.id = id;
